...
--First I go to find description about crime
...
--Checking bakery security                                                   |
 SELECT * FROM bakery_security_logs WHERE year = 2021 AND month = 7 AND day = 28 AND hour = 10 AND minute < 26 AND minute > 14;
--  +-----+------+-------+-----+------+--------+----------+---------------+
...
--people whose license plate in footage
-- +--------+---------+----------------+-----------------+---------------+
...
--persons with accounts of transactions
-- +--------+---------+----------------+-----------------+---------------+
-- |   id   |  name   |  phone_number  | passport_number | license_plate |
-- +--------+---------+----------------+-----------------+---------------+
...
-- +----+--------------+-----------------------------------------+---------------+
--flight from fiftyville on next day
